...
vim.keymap.set("n", "<Leader>n", "<CMD>Neotree reveal<CR>", { desc = "File Explorer" })
...
vim.keymap.set("n", "<Leader>fl", vim.lsp.buf.format, { desc = "Format (First LSP client)" })
vim.keymap.set("n", "<Leader>ff", vim.cmd.FormatChooseLsp, { desc = "Format (Choose LSP if many available)" })
